...
const index = () => {
  ...
  return (
    <> 
    <div className={`${(openLang) ?style.commonClass:""}`} onClick={commonClose}></div>
    <div className="mx-2">
    <img
    ...
    <div
      style={{ width: "85px", height: "150px" }}  //openLangClass
      className={`${(openLang) ?style.openLangClass:style.modalLangClass} bg-admin-openMenu1 `}
    >
